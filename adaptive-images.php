...
$resolutions   = array(1382, 992, 768, 480, 120); // the resolution break-points to use (screen widths, in pixels)
$cache_path    = 'data/thumbnails'; // where to store the generated re-sized images. Specify from your document root!
...
if (!file_exists($source_file)) {
	$source_file = $document_root . '/theme/img/' . (($resolution & $resolution < 130) ? 'mini_' : '') . 'preview_fon.png';
