...
?>
	<form class="upload" action="/feedback/send" method="POST">
		...
		<?err('name', 'Ваши имя и фамилия')?> <input type="text" name="name" value="<?echo $name?>" /><br/><br/>
		<?err('contact', 'Ваши контакты')?><textarea name="contact"><?echo $contact?></textarea><br/><br/>
		<?err('msg', 'Текст сообщения')?><textarea name="msg"><?echo $msg?></textarea><br/><br/>
